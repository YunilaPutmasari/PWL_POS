...
class TransaksiPenjualanController extends Controller
{
    ...
    {
        $penjualan = PenjualanModel::find($id);
        $detailPenjualan = DetailPenjualanModel::where('penjualan_id', $id)->first();
        $user = UserModel::all();
    ...
    public function update(Request $request, $id)
    {
        ...
        $detailPenjualan = DetailPenjualanModel::where('penjualan_id', $id)->first(); // Menggunakan first() untuk mendapatkan objek tunggal
